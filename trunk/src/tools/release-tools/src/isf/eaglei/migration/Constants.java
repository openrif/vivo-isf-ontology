...
//	public static String DROPBOX_ROOT = "C:/s/Dropbox/_shared/eaglei-mirgration";
//	public static String EAGLEI_ROOT = "C:/s/svns/eaglei-isf-migration";
//	public static String ISF_ROOT = "C:/s/svns/isf-new-layout";
//	public static String EAGLEI_RELEASE_UNREASONED_PATH = "releases/2013-08-02/ero-unreasoned.owl";
//	public static String ISF_RELEASE_UNREASONED_PATH = "release/2013-07-31/isf.owl";
